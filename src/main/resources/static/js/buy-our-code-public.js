    ...
    $('#results').append(
        '<div class="col-lg-4 my-3">' +
            '<div class="text-center p-1 rounded bg-light shadow-sm product">' +
                '<div class="my-3" style="height:50px"><a class="product-title" href="/buy-our-code/' + course.code + '">' + course.title + '</a></div>' +
...
function prepareCourseInteractionButton(course) {
    if(course.saleStatus === 'o') {
        ...
        return '<a type="button" class="btn btn-outline-success" href="/buy-our-code/' + course.code + '"></i>' + lang.home_findOutMore + '</a>';
    }
}
...
function goToDetailsPage(code) {
    window.location.href = '/buy-our-code/' + code;
}
