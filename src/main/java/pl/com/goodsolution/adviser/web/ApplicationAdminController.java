...
import pl.com.goodsolution.adviser.domain.adviser.ContextConfigData;
...
import pl.com.goodsolution.adviser.logic.adviser.ApplicationsService;
import pl.com.goodsolution.adviser.logic.adviser.ContextConfigsService;
import pl.com.goodsolution.adviser.logic.courseplatform.*;
import pl.com.goodsolution.adviser.logic.itube.ITubeService;

import static pl.com.goodsolution.adviser.logic.courseplatform.ConverterToResponsesUtil.iTubesToResponsesAdmin;
import static pl.com.goodsolution.adviser.logic.courseplatform.ConverterToResponsesUtil.modulesToResponses;
...
public class ApplicationAdminController {
    ...
    public String lesson(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("modulesInCourse", modulesToResponses(modulesService.find(new ModulesFilter(lesson.getCourse().getId(), false))));
...
//        }
    ...
    public String iTube(@PathVariable Long id, Model model) {
        ITubeGetResponseAdmin iTubeGetResponseAdmin = iTubesToResponsesAdmin(iTubeService.find(new ITubeFilter(id))).get(0);
