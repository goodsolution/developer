...
import pl.com.goodsolution.adviser.domain.adviser.AdviceVariableData;
import pl.com.goodsolution.adviser.domain.adviser.AdviceVariablesFilter;
import pl.com.goodsolution.adviser.domain.adviser.AdviseDataType;
...
@Service
class AdviserVariablesJdbcRepository {
    private static final Logger log = LoggerFactory.getLogger(AdviserVariablesJdbcRepository.class);
    private JdbcTemplate jdbcTemplate;

    private DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-LL-dd HH:mm:ss.S");

    public AdviserVariablesJdbcRepository(JdbcTemplate jdbcTemplate) {
...
//        log.trace(query);
//
        return prepareAdviceVariablesData(jdbcTemplate.queryForList(query));
//        return null;
    }
...
//    }
//
    private List<AdviceVariableData> prepareAdviceVariablesData(List<Map<String, Object>> rows) {
        List<AdviceVariableData> list = new ArrayList<>();
        for (Map<String, Object> row : rows) {
            AdviceVariableData advice = new AdviceVariableData(
                    Long.valueOf(String.valueOf(row.get("id"))),
                    String.valueOf(row.get("name")),
                    AdviseDataType.valueOf(String.valueOf(row.get("type"))),
