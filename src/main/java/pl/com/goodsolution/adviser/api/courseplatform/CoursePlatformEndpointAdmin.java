...
import pl.com.goodsolution.adviser.api.PurchasedCoursesAdminRequestGetResponse;
...
import pl.com.goodsolution.adviser.logic.courseplatform.notifications.NotificationsFromPanelService;
...
public class CoursePlatformEndpointAdmin {
    ...
    public LessonAttachmentsGetResponse getLessonAttachments(@PathVariable Long lessonId) {
        ...
        return new LessonAttachmentsGetResponse(lessonAttachmentsToResponsesAdmin(lessonAttachments));
    }
    ...
    public JobOffersGetResponse getJobOffers(
        ...
        return new JobOffersGetResponse(jobOffersToResponses(jobOffers));
    }
    ...
    public PeopleGetResponse getContactsPeople(
        ...
        return new PeopleGetResponse(peopleToResponses(people));
    ...
    public CourseCommentsRequestGetResponseAdmin getCourseComments(
        ...
        return new CourseCommentsRequestGetResponseAdmin(courseCommentsToResponsesAdmin(courseComments));
    }
    ...
    public LessonCommentsRequestGetResponseAdmin getLessonComments(
        ...
        return new LessonCommentsRequestGetResponseAdmin(lessonCommentsToResponsesAdmin(lessonComments));
    }
    ...
    public StatisticCourseCompletionRequestGetResponse courseCompletion(@RequestParam(name = "page", required = false, defaultValue = "1") Long page,
        ...
        return new StatisticCourseCompletionRequestGetResponse(courseCompletionToResponses(courses));
    }
    ...
    public ModulesRequestGetResponse findModules(@RequestParam Long courseId) {
        ...
        return new ModulesRequestGetResponse(modulesToResponses(modules));
    }
    ...
    public TracePerDayResponse findTracesPerDay(@RequestParam Month month) {
        ...
        return new TracePerDayResponse(traceToResponses(traces));
    }
    ...
    public TracePerDayResponse findTracesPerMonth(@RequestParam Long year) {
        ...
        return new TracePerDayResponse(traceToResponses(trace));
