...
public class VehiclesRepository {
    ...
    public Long getVehicleCepikIdToUpdate() {
        ...
        for (Map<String, Object> row : rows) {
            return JdbcUtil.getLong(row, "vech_id");
        }
    ...
    public VehiclesParams getVehicleParamToUpdate() {
        ...
        for (Map<String, Object> row : rows) {
            vehiclesParams.add(new VehiclesParams(
                    ...
                    JdbcUtil.getString(row, "voivodeship_code"),
                    JdbcUtil.getDateTime(row, "last_refresh_date_time"),
                    JdbcUtil.getDateTime(row, "date_from").toLocalDate(),
                    JdbcUtil.getDateTime(row, "date_to").toLocalDate(),
                    JdbcUtil.getInteger(row, "page"),
                    JdbcUtil.getDateTime(row, "generating_params_date_time")
            ));
        }
    ...
    List<CarTransformed> findVehicles(CarsFilter filter) {
        ...
        if (filter != null) {
            ...
            query += JdbcUtil.preparePaginationQuery(filter.getPages(), filter.getPageSize());
        }
        List<Map<String, Object>> rows = jdbcTemplate.queryForList(query);
        for (Map<String, Object> row : rows) {
            vehicles.add(new CarTransformed(
                    JdbcUtil.getLong(row, "vech_id"),
                    JdbcUtil.getString(row, "vehicle_type"),
                    JdbcUtil.getString(row, "vehicle_brand"),
                    JdbcUtil.getString(row, "vehicle_model"),
                    JdbcUtil.getString(row, "vehicle_kind"),
                    JdbcUtil.getString(row, "vehicle_date_first_registration"),
                    JdbcUtil.getString(row, "vehicle_vin"),
                    JdbcUtil.getString(row, "vehicle_category"),
                    JdbcUtil.getString(row, "vehicle_variant"),
                    JdbcUtil.getString(row, "vehicle_version"),
                    JdbcUtil.getString(row, "vehicle_subtype"),
                    JdbcUtil.getString(row, "vehicle_destination"),
                    JdbcUtil.getString(row, "vehicle_origin"),
                    JdbcUtil.getString(row, "vehicle_nameplate_type"),
                    JdbcUtil.getString(row, "vehicle_method_of_production"),
                    JdbcUtil.getString(row, "vehicle_year_of_production"),
                    JdbcUtil.getString(row, "vehicle_date_first_registration_in_country"),
                    JdbcUtil.getString(row, "vehicle_date_last_registration_in_country"),
                    JdbcUtil.getString(row, "vehicle_date_first_registration_abroad"),
                    JdbcUtil.getDouble(row, "vehicle_engine_displacement"),
                    JdbcUtil.getDouble(row, "vehicle_motor_power_to_weight_ratio_motorcycles"),
                    JdbcUtil.getDouble(row, "vehicle_engine_net_power"),
                    JdbcUtil.getDouble(row, "vehicle_max_net_power_of_engine_hybrid"),
                    JdbcUtil.getDouble(row, "vehicle_own_mass"),
                    JdbcUtil.getDouble(row, "vehicle_mass_of_ready_to_run"),
                    JdbcUtil.getDouble(row, "vehicle_permissible_gross_weight"),
                    JdbcUtil.getDouble(row, "vehicle_maximum_total_mass"),
                    JdbcUtil.getDouble(row, "vehicle_allowed_package"),
                    JdbcUtil.getDouble(row, "vehicle_maximum_payload"),
                    JdbcUtil.getDouble(row, "vehicle_permissible_total_weight_of_vehicle_combinations"),
                    JdbcUtil.getDouble(row, "vehicle_number_of_axles"),
                    JdbcUtil.getDouble(row, "vehicle_allowable_axle_load"),
                    JdbcUtil.getDouble(row, "vehicle_maximum_axle_weight"),
                    JdbcUtil.getDouble(row, "vehicle_max_total_weight_of_trailed_trailer_without_brake"),
                    JdbcUtil.getDouble(row, "vehicle_max_total_weight_trailer_without_brake"),
                    JdbcUtil.getInteger(row, "vehicle_number_seats_total"),
                    JdbcUtil.getInteger(row, "vehicle_number_of_seats"),
                    JdbcUtil.getInteger(row, "vehicle_number_of_standing_places"),
                    JdbcUtil.getString(row, "vehicle_type_of_fuel"),
                    JdbcUtil.getString(row, "vehicle_kind_of_first_alternative_fuel"),
                    JdbcUtil.getString(row, "vehicle_kind_of_second_alternative_fuel"),
                    JdbcUtil.getDouble(row, "vehicle_avg_fuel_consumption"),
                    JdbcUtil.getDouble(row, "vehicle_co2_emission_level"),
                    JdbcUtil.getString(row, "vehicle_kind_of_suspensions"),
                    JdbcUtil.getString(row, "vehicle_equipment_and_type_of_radar_device"),
                    JdbcUtil.getBoolean(row, "vehicle_hook"),
                    JdbcUtil.getBoolean(row, "vehicle_steering_right_hand_side"),
                    JdbcUtil.getBoolean(row, "vehicle_steering_right_side_originally"),
                    JdbcUtil.getBoolean(row, "vehicle_catalyst_absorber"),
                    JdbcUtil.getString(row, "vehicle_manufacturer_name"),
                    JdbcUtil.getString(row, "vehicle_car_transport_institute_code"),
                    JdbcUtil.getDouble(row, "vehicle_wheel_base_steering_other_axles"),
                    JdbcUtil.getDouble(row, "vehicle_maximum_track_width"),
                    JdbcUtil.getDouble(row, "vehicle_avg_spacing_col"),
                    JdbcUtil.getBoolean(row, "vehicle_min_track_width"),
                    JdbcUtil.getDouble(row, "vehicle_exhaust_emission_reduction"),
                    JdbcUtil.getString(row, "vehicle_type_encoding_kind_subtype_destiny"),
                    JdbcUtil.getString(row, "vehicle_code_kind_subgenus_destiny"),
                    JdbcUtil.getString(row, "vehicle_date_of_deregistration"),
                    JdbcUtil.getString(row, "vehicle_reason_for_deregistration_of_vehicle"),
                    JdbcUtil.getString(row, "vehicle_date_data_input"),
                    JdbcUtil.getString(row, "vehicle_registration_voivodeship"),
                    JdbcUtil.getString(row, "vehicle_registration_community"),
                    JdbcUtil.getString(row, "vehicle_registration_country"),
                    JdbcUtil.getString(row, "vehicle_owner_voivodeship"),
                    JdbcUtil.getString(row, "vehicle_owner_district"),
                    JdbcUtil.getString(row, "vehicle_owner_commune"),
                    JdbcUtil.getString(row, "vehicle_owner_voivodeship_code"),
                    JdbcUtil.getString(row, "vehicle_voivodeship_code"),
                    JdbcUtil.getDouble(row, "vehicle_co2_emission_level_first_fuel_alternative")
            ));
        }
        return vehicles;
    }
