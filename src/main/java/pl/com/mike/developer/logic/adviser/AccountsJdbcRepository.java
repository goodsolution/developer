...
import pl.com.mike.developer.domain.adviser.AccountType;
        ...
        try {
            return jdbcTemplate.queryForObject(query, new Object[]{id},
                    (rs, rowNum) -> new AccountData(
                            ...
                            JdbcUtil.getInteger(rs, "preferred_hour_from"),
                            JdbcUtil.getInteger(rs, "preferred_hour_to"),
                            JdbcUtil.getBoolean(rs, "all_day"),
                            JdbcUtil.getBoolean(rs, "newsletter_accepted"),
                            JdbcUtil.getString(rs, "name"),
                            AccountType.fromCode(JdbcUtil.getString(rs, "type"))
                    ));
