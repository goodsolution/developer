...
import pl.com.mike.developer.logic.courseplatform.notifications.NotificationsService;
...
public class CoursePlatformEndpoint {
    ...
    public LessonsRequestGetResponse getLessons(@PathVariable Long courseId) {
        ...
        for (ModuleData moduleInCourse : modulesInCourse) {
            ...
            modulesInCourseResponses.add(new ModuleGetResponse(moduleInCourse, ConverterToResponsesUtil.lessonsToResponses(lessons)));
        }

        return new LessonsRequestGetResponse(ConverterToResponsesUtil.lessonsToResponses(lessonsWithoutModule), modulesInCourseResponses);
    }
    ...
    public MemesRequestGetResponse getMemes(@PathVariable Long page) {
        return new MemesRequestGetResponse(ConverterToResponsesUtil.memesToResponses(memesService.findMemesForPage(page)));
    }
    ...
    public CourseCommentsRequestGetResponsePublic getCourseComments(@PathVariable Long courseId) {
        ...
        return new CourseCommentsRequestGetResponsePublic(ConverterToResponsesUtil.courseCommentsToResponsesPublic(courseComments));
    }
    ...
    public LessonCommentsRequestGetResponsePublic findLessonComments(@PathVariable Long lessonId) {
        ...
        return new LessonCommentsRequestGetResponsePublic(ConverterToResponsesUtil.lessonCommentsToResponsesPublic(lessonComments));
    }
    ...
    public JobOffersGetResponse findJobOffers(@PathVariable Long page) {
        return new JobOffersGetResponse(ConverterToResponsesUtil.jobOffersToResponses(jobOffersService.find(new JobOffersFilter(page, 10L, Boolean.FALSE))));
    }
